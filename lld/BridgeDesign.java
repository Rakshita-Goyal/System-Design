//cocept into high level part and low level part
//hlp is abstraction and (car)
//llp is the implementation  (engine)
//m*n to m+n 

//bridge decouples an abstraction from its implementations ,so that both can vary imdependently
package lld;
interface Engine {
    void start();
}
